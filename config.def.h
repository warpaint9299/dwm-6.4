...
static const char *barlayout        = "tln";   /* l: layout indicator n: window name s: status (xsetroot) t: tag indicators |: split point */
...
#define BARTAB_TAGSPX 3        // # pixels for tag grid boxes
